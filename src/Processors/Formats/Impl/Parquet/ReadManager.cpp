...
{
    //TODO: distribute memory_target_fraction more carefully: 0 for skipped stages, higher for columns
    double sum = 0;
...
void ReadManager::scheduleTasksIfNeeded(ParsingStage stage_idx, std::unique_lock<std::mutex> & /*stage_lock*/)
{
    ...
    //TODO: maybe schedule in batches
...
void ReadManager::scheduleTask(Task task, MemoryUsageDiff * diff)
{
    ...
    thread_pool->parsing_pool->scheduleOrThrow([this, task]
        {
