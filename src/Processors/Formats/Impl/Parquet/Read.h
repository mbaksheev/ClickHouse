...
// TODO: check if the LowCardinality thing runs fast; if not, do partial conversion to full column
...
// TODO: assert that memory usage is zero at the end, the reset()s are easy to miss
// TODO: make sure to not convert to full column if requested type is LowCardinality
// TODO: make writer write DataPageV2
// TODO: make writer write SizeStatistics
// TODO: try adding [[unlikely]] to all ifs
// TODO: support or deprecate the preserve-order setting
// TODO: stats (reuse the ones from the other PR?)
...
struct ValueDecoder
{
    ...
    virtual void decodePage(parq::Encoding::type, const char * /*data*/, size_t /*bytes*/, size_t /*num_values*/, IColumn &, const UInt8 * /*filter*/) const { chassert(false); }
