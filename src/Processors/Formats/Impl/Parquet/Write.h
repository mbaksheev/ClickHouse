...
struct WriteOptions
{
    ...
    /// Note: the meaning of CompressionMethod::Lz4 here is different from normal: here
    /// it's lz4 block format, while in Lz4InflatingReadBuffer/Lz4DeflatingWriteBuffer
    /// it's lz4 framed format.
